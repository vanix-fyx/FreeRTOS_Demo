...
QueueHandle_t g_xQueueIRReceiver;
...
#endif
		g_xQueueIRReceiver = xQueueCreate(10,sizeof(IRReceiver_Data_Struct));
}
...
void IRReceiver_Test(void)
{
    ...
    while (1)
    {
        ...
        {
            OLED_ShowString(3, 1, "                ");
            OLED_ShowHexNum(3, 1, dev, 1);
            OLED_ShowHexNum(3, 9, data, 1);
            OLED_ShowString(4, 1, "                ");
            OLED_ShowString(4, 1, "Key name: ");
            OLED_ShowString(4, 11, (char*)IRReceiver_CodeToString(data));
        }
    }
}
...
void vIRReceiverTaskFunction(void* pvParameters)
{
    ...
    IRReceiver_Init();
        ...
        {
            OLED_ShowString(3, 1, "                ");
            OLED_ShowString(3, 1, "0x");OLED_ShowHexNum(3, 3, dev, 2);
            OLED_ShowString(3, 9, "0x");OLED_ShowHexNum(3, 11, data, 2);
            OLED_ShowString(4, 1, "                ");
            OLED_ShowString(4, 1, "Key name: ");
            OLED_ShowString(4, 11, (char*)IRReceiver_CodeToString(data));
        }
